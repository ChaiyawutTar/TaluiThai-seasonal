...
if __name__ == '__main__':
    ...
    # attraction_ids_train, attraction_ids_val = attraction_ids_exp[train_indices], attraction_ids_exp[val_indices] # For SHAP
    ...
    with mlflow.start_run() as run:
        ...
        input_example = (
            torch.randint(0, VOCAB_SIZE, (1, MAX_SEQUENCE_LENGTH)).to(device),       # b_text
